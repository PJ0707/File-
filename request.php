...
<?php
 ...
 ?>
<div class="c2" style="flex-basis:20px">
...
."'"; 
 ...
 $insert_query_result=mysqli_query($con,$insert_query) or die(
mysqli_error($con)); 
 } 
 ?> 
 <script>
...
."'"; 
 ...
 if(!strcmp($tname,"level2_table")) 
 { 
 $query="update file_table set status = -
2 where fileid = '".$name."'"; 
 $exe = mysqli_query($con,$query); 
 } 
 else{ 
